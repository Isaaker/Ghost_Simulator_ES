<img src="https://github.com/Isaaker/Ghost_Simulator_ES/blob/main/images/Archery_Ghost_Simulator.png?raw=true" alt="Logo de Archery Ghost Simulator" width="150" height="150">

# Condiciones de uso de Archery Ghost Simulator

**Versión 2.3 - 13/10/23**
...
* No está permitido usar el código de ninguna manera que viole los derechos de autor, las marcas registradas u otros derechos de propiedad intelectual del autor o de cualquier tercero.
* No está permitido usar el código de ninguna manera que sea dañina, maliciosa o ilegal.
* No está permitido alquilar, arrendar, prestar, cargar o alojar en ningún sitio web o servidor, vender, redistribuir o sublicenciar el código, en su totalidad o en parte, ni permitir que otros lo hagan.
* No está permitido utilizar la plataforma para fines comerciales.
...
## 9. Uso abusivo de la plataforma
